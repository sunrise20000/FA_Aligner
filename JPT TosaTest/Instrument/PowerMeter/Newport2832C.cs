...
{
    public class Newport2832C : PowerMeterBase
    {
        #region Definition
        ...
        public Newport2832C(InstrumentCfg InstrumentCfg,ICommunicationPortCfg CommunicationCfg) : base(InstrumentCfg,CommunicationCfg)
        {
            IsMultiChannel = true;
